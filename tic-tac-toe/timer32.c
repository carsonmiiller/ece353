...
volatile bool S2_pressed_70mS = false;
...
/*
 * Detect when S2 has been pressed for a minimum of 70mS.
 * Set a global variable that indicates when this has happened.
...
void T32_INT1_IRQHandler(void){
    ...
    if(button_state == 0x7F)
        S2_pressed_70mS = true; // set global variable to true
    while(button_pressed)){}   // busy wait until button is released
